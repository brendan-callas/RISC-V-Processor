...
assign mem_rdata = mem_rdata256[(32*prev_address[4:2]) +: 32];
assign mem_byte_enable256 = {28'h0, mem_byte_enable} << (prev_address[4:2]*4);

endmodule : bus_adapter_p
